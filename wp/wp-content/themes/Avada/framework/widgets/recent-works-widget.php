...
if ( ! class_exists( 'Fusion_Recent_Works_Widget' ) ) {
	add_action('widgets_init', 'fusion_recent_works_load_widgets');

	function fusion_recent_works_load_widgets()
	{
		register_widget('Fusion_Recent_Works_Widget');
	}

	class Fusion_Recent_Works_Widget extends WP_Widget {

		function Fusion_Recent_Works_Widget()
		{
