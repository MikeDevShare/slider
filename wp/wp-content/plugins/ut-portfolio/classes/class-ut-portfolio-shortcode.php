								...
								if( $detailstyle == 'popup' ) {
									...
									if( empty( $post_format ) || $post_format == 'audio' ) {
										...
										if($external) {
											...
											$carousel .= '<a class="' . $portfolio_settings['image_style'] . '" rel="bookmark" title="' . $title . '" href="'.$external.'" target="_blank">';
						...
						if( $detailstyle == 'popup' ) {
							...
							if( empty( $post_format ) || $post_format == 'audio' ) {
								...
								if($external) {
									...
									$masonry .= '<a class="' . $portfolio_settings['image_style'] . '" rel="bookmark" title="' . $title . '" href="'.$external.'" target="_blank">';
							...
							if( $detailstyle == 'popup' ) {
								...
								if( empty( $post_format ) || $post_format == 'audio' ) {
									...
									if( !empty($external) ) {
										...
										$gallery .= '<a class="' . $image_style_class . '" rel="bookmark" title="' . $title . '" href="'.$external.'" target="_blank">';
